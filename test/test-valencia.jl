...
@testset "dij_dist Valencia" begin
    ...
    eereco = EERecoJet[
        EERecoJet(1, 0, Inf, Inf, 1.0, 0.0, 0.0, 1.0),
...
@testset "Valencia distance wrappers" begin
    ...
    eereco = EERecoJet[
        EERecoJet(1, 0, Inf, Inf, 1.0, 0.0, 0.0, 9.0),
...
@testset "ee_genkt_algorithm Valencia" begin
    ...
    cs = ee_genkt_algorithm(
        particles; algorithm = JetAlgorithm.Valencia, β = 1.2, γ = 1.2,
        R = 0.8
    )
...
@testset "_ee_genkt_algorithm Valencia dij_factor" begin
    ...
    R = 0.8
    invR2 = 1.0 / (R * R)
    cs = JetReconstruction._ee_genkt_algorithm!(
        jets;
