...
@testset "dij_dist Valencia" begin
    ...
    eereco = StructArray([EERecoJet{Float64}(1, 0, Inf, Inf, 1.0, 0.0, 0.0, 1.0),
                       EERecoJet{Float64}(2, 0, Inf, Inf, 0.0, 1.0, 0.0, 2.0)])
...
@testset "Valencia distance wrappers" begin
    ...
    eereco = StructArray([EERecoJet{Float64}(1, 0, Inf, Inf, 1.0, 0.0, 0.0, 9.0),
                       EERecoJet{Float64}(2, 0, Inf, Inf, 1.0, 0.0, 0.0, 4.0)])
    R = 2.0
