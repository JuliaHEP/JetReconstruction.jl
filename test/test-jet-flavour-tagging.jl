...
if !HAS_FLAVOUR_TAGGING
    ...
    @testset "Jet Flavour Tagging Extension" begin
        ...
        onnx_data_dir = joinpath(package_root, "examples", "flavour-tagging", "data",
        ...
        if has_test_files
            @testset "Full Flavour Tagging Pipeline" begin
                ...
                @testset "Jet Reconstruction" begin
                    ...
                    cs = jet_reconstruct(recps; p = 1.0, R = 2.0,
                ...
                @testset "build_constituents_cluster" begin
                    ...
                    # Build constituents
                    jet_constituents = JetReconstruction.build_constituents_cluster(recps,
                                                                                    constituent_indices)
                    @test length(jet_constituents) == 2
                    @test all(jc -> isa(jc, StructVector{ReconstructedParticle}),
                              jet_constituents)
                end
